package com.hnv99.exam.common.aop;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * com.hnv99.exam.controller..*Controller.*(..))")
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        LOG.info("------------- End Time Taken: {} ms -------------", System.currentTimeMillis() - startTime);
        return result;
    }
